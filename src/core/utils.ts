 ...
 */
export const getInnerItemInArray = (data: unknown): null | GetInnerResult => {
 ...
 */
export const isArray = (data: unknown): boolean => Object.prototype.toString.call(data) === '[object Array]'

/**
 * @param data 
 * @returns {boolean} is Object
 */
export const isObject = (data: unknown): boolean => Object.prototype.toString.call(data) === '[object Object]'
